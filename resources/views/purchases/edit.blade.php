...
<div class="card">
    <div class="card-header">
        <h5 class="mb-0">Edit Purchase Order - {{ $purchase->purchase_number }}</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('purchases.update', $purchase) }}" method="POST" id="purchaseForm">
            ...
            <div class="row mb-4">
                <div class="col-12">
                    ...
                    <textarea name="notes" rows="3" class="form-control @error('notes') is-invalid @enderror" 
                              placeholder="Optional notes about this purchase...">{{ old('notes', $purchase->notes) }}</textarea>
                    @error('notes')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="mb-4">
                ...
                <div id="purchaseItems">
                    @php
                        $itemsData = old('items', $purchase->purchaseItems->map(function($item, $index) {
                            return [
